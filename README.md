...
To set up the project, clone this repository and run the SQL files in your PostgreSQL database to initialize the models and queries.

## Installation

1. Clone the repository

2. Set up your PostgreSQL database using the provided SQL scripts.
